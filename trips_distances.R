...
cbgs = as.numeric(cbg$coords)
pois = as.numeric(pois$coords)

cbgs[1] = POI_trips_sub$cbg_lat[1]
cbgs[2] = POI_trips_sub$cbg_lon[2]
pois[1] = POI_trips_sub$POI_lat[1]
pois[2] = POI_trips_sub$POI_lon[2]
...
route = osrmRoute(src = c(cbgs[1], cbgs[2]) , dst = c(pois[1], pois[2]) , osrm.profile = "car")
